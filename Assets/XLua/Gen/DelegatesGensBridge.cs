...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(XLuaFramework.LuaViewBehaviour.delLuaStart))
			{
			    return new XLuaFramework.LuaViewBehaviour.delLuaStart(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(XLuaFramework.LuaViewBehaviour.delLuaUpdate))
			{
			    return new XLuaFramework.LuaViewBehaviour.delLuaUpdate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(XLuaFramework.LuaViewBehaviour.delLuaOnDestroy))
			{
		    ...
		    if (type == typeof(XLuaFramework.LuaViewBehaviour.delLuaAwake))
			{
			    return new XLuaFramework.LuaViewBehaviour.delLuaAwake(__Gen_Delegate_Imp14);
			}
